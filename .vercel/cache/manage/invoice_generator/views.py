...
def extract_lc_data(pdf_path):
    extracted_data = {
        ...
        'quantity': 'Unknown',  # You can also remove 'quantity' if no longer needed
    }
    ...
    # No conversion to quantity anymore, just return the weight
    extracted_data['quantity'] = extracted_data['weight']  # Use the actual weight
